...
@Serializable
data class Ping(val eventTime: Instant) : Event

@Serializable
data class Joined(val eventTime: Instant, val channel: Channel) : Event

@Serializable
data class Left(val eventTime: Instant, val channel: Channel) : Event

@Serializable
data class MessageCreated(val eventTime: Instant, val message: Message) : Event

@Serializable
data class MessageDeleted(val eventTime: Instant, val message: DeletedMessage) : Event

@Serializable
data class MessageUpdated(val eventTime: Instant, val message: Message) : Event

@Serializable
data class DirectMessageCreated(val eventTime: Instant, val message: Message) : Event

@Serializable
data class DirectMessageDeleted(val eventTime: Instant, val message: DeletedDirectMessage) : Event

@Serializable
data class DirectMessageUpdated(val eventTime: Instant, val message: Message) : Event
...
@Serializable
data class ChannelCreated(val eventTime: Instant, val channel: Channel) : Event
...
@Serializable
data class UserCreated(val eventTime: Instant, val user: User) : Event

@Serializable
data class UserActivated(val eventTime: Instant, val user: User) : Event

@Serializable
data class UserGroupCreated(val eventTime: Instant, val group: UserGroup) : Event

@Serializable
@OptIn(ExperimentalUuidApi::class)
data class UserGroupUpdated(val eventTime: Instant, val groupId: Uuid) : Event

@Serializable
@OptIn(ExperimentalUuidApi::class)
data class UserGroupDeleted(val eventTime: Instant, val groupId: Uuid) : Event

@Serializable
data class UserGroupMemberAdded(val eventTime: Instant, val groupMember: UserGroupMember) : Event

@Serializable
data class UserGroupMemberUpdated(val eventTime: Instant, val groupMember: UserGroupMember) : Event

@Serializable
data class UserGroupMemberRemoved(val eventTime: Instant, val groupMember: UserGroupMember) : Event

@Serializable
data class UserGroupAdminAdded(val eventTime: Instant, val userGroup: UserGroupMember) : Event

@Serializable
data class UserGroupAdminRemoved(val eventTime: Instant, val userGroup: UserGroupMember) : Event
...
@Serializable
@OptIn(ExperimentalUuidApi::class)
data class TagAdded(val eventTime: Instant, val tagId: Uuid, val tag: String) : Event

@Serializable
@OptIn(ExperimentalUuidApi::class)
data class TagRemoved(val eventTime: Instant, val tagId: Uuid, val tag: String) : Event
