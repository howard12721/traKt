package com.github.howard12721.trakt.bot

import com.github.howard12721.trakt.rest.apis.*
import com.github.howard12721.trakt.websocket.WebSocketClient

class TraktClient(private val token: String) {
    ...
    init {
        ...
        this.qallApi.setBearerToken(token)
