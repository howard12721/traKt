...
internal data class UserGroupMember(
    val groupId: Uuid,
    val userId: Uuid,
)
...
@Serializable
@OptIn(ExperimentalUuidApi::class)
internal data class RoledUserGroupMember(
    val groupId: Uuid,
    val userId: Uuid,
    val role: String
)
...
@Serializable
@OptIn(ExperimentalUuidApi::class)
internal data class DeletedMessage(
    val id: Uuid,
    val channelId: Uuid,
)
...
@Serializable
@OptIn(ExperimentalUuidApi::class)
internal data class DeletedDirectMessage(
    val id: Uuid,
    val userId: Uuid,
    val channelId: Uuid,
)
...
@Serializable
@OptIn(ExperimentalUuidApi::class)
internal data class ReactionStamp(
    val stampId: Uuid,
    val userId: Uuid,
    val count: Int,
